	    ...
	    for (j = 0; j < COL; ++j)
	    {
		  ...
		  do
		  {
		    ...
		    cin >> escolher;
			    ...
			    {
			      cout << endl
				   << "A organizacao das poltronas deste  se dá por: 15 fileiras, cada fileira tem 40 poltronas." << endl;
				...
				cout << endl
				     << "Parabéns! sua reserva foi realizada. Caso queira continuar pode escolher outra poltrona." << endl;
			      }
			      else
			      {
				cout << endl
				     << "Oops!! Infelizmente não foi possível efetuar sua reserva, esta poltrona já foi escolhida. Por favor, faça outra escolher." << endl;
			      }
			    }
